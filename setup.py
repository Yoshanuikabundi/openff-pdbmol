...
short_description = "Stats collection from the PDB databank.".strip().split("\n")[0]
...
setup(
    ...
    author_email='josh.mitchell@openforcefield.org',
    ...
    # url='openff-pdbscan.readthedocs.io/en/latest/',  # Website
    # platforms=['Linux',
    #            'Mac OS-X',
    #            'Unix',
