...
version = openff.pdbscan.__version__
# The full version, including alpha/beta/rc tags
release = openff.pdbscan.__version__
...
if find_import_spec("notfound"):
    ...
    notfound_urls_prefix = "/projects/pdbscan/en/stable/"
    notfound_context = {
...
html_theme_options = {
    ...
    "repo_url": "https://github.com/yoshanuikabundi/openff-pdbscan",
    # The name of the repo. If must be set if repo_url is set
    "repo_name": "openff-pdbscan",
