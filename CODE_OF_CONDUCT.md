...
The OpenFF PDBScan *Code of Conduct* sets the rules for the behavior of
every member in the OpenFF PDBScan community so that everyone can
...
OpenFF PDBScan is part of an engaged and respectful community made up of people from all
...
avoid, you will help us make OpenFF PDBScan a welcoming and productive community.
...
7. **When we disagree, try to understand why**. Disagreements, both social and
   technical, happen all the time and OpenFF PDBScan is no exception. It is important
   that we resolve disagreements and differing views constructively. Remember
   that we’re different. The strength of OpenFF PDBScan comes from its varied community
...
reported by contacting the project team at 'josh.mitchell@openforcefield.org'. The project team will
